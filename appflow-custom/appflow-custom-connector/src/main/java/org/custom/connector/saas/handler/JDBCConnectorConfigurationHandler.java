...
package org.custom.connector.saas.handler;
...
//import org.custom.connector.saas.client.JDBCClient;
//import org.custom.connector.saas.client.JDBCClientFactory;
import org.custom.connector.saas.config.JDBCConnectorConfiguration;
...
public class JDBCConnectorConfigurationHandler implements ConfigurationHandler {
  private static final String CONNECTOR_OWNER = "simpsnm";
  private static final String CONNECTOR_NAME = "SaaSConnector";
  ...
  public ValidateCredentialsResponse validateCredentials(final ValidateCredentialsRequest request) {
    ...
    try {
      LOGGER.info(request.credentials().toString());
