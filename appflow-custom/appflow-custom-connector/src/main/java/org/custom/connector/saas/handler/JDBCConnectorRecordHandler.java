...
import org.custom.connector.saas.client.IHttpClient;
import org.custom.connector.saas.client.HttpClientFactory;

import org.custom.connector.saas.validation.JDBCRequestValidator;
...
public final class JDBCConnectorRecordHandler implements RecordHandler {
  ...
  public WriteDataResponse writeData(final WriteDataRequest request) {
    ...
    try {
      IHttpClient client = httpClient.create(request.connectorContext().credentials());
